...
const FLOWS = {
    ...
    Online: [
        {
            email: "hendriaryo1207@gmail.com",
            name: "Hendri Aryo Mufatoh",
...
function App() {
  ...
  this.url = "https://script.google.com/macros/s/AKfycbwVpRSxcBFHq3N_bv1L_rCDRkWfU0Gke9oeRd2OuSH-Bg_0Y__VoLt-AVnk5dxekcFQKw/exec" // IMPORTANT - copy the web app url after deploy
  this.title = this.form.getTitle()
  this.desription = this.form.getDescription()
  this.sheetname = "Form Responses 10" // DO NOT change - the default google form responses sheet name
